...
## Mutate variables
```{r}
#dw %>% select(employstatus_1) %>% table()
dw %>% select(PFS01) %>% table()
dw %>% select(isoFriends_inPerson) %>% table()
dw %>% select(isoOthPpl_inPerson) %>% table()
dw %>% select(isoFriends_online) %>% table()
dw %>% select(isoOthPpl_online) %>% table()
dw %>% select(persRelSat) %>% table()
dw %>% select(lone01) %>% table()
dw %>% select(happy) %>% table()
dw %>% select(coronaClose_1) %>% table()
dw %>% select(houseLeave) %>% table()
dw %>% select(neuro01) %>% table()

dw %>% select(countryCitizen:representative) %>% skim()
dw %>% select(respSetMean, respSetSd) %>% skim()

dw %>% select(ConfirmedCases:StringencyIndex) %>% skim()
```
