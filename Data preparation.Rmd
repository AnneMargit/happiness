...
dl %>% select(Emp1:Emp4, job_parttime, job_fulltime, job_24, job_39, job_40, job_na)
```
...
dl %>% filter(!is.na(liv_sit)) %>% select(liv_sit, liv_mother, liv_father, liv_parent, liv_child, liv_house, liv_other)
```
